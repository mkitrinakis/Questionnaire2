...
{
    public class QuestionnaireModelA_V2 : QuestionnaireModel
    {
        ...
        public Dictionary<int, string> Q1Options = InMemory.getEduTypes();

        public string Q1100 = "ΒΟΗΘΟΣ ΒΡΕΦΟΝΗΠΙΟΚΟΜΩΝ (Γ Εξάμηνο)";
        public Dictionary<int, string> Q1100Options = InMemory.getEduTypes();
        public string Q1101 { get; set; } = "";
        public string Q1101Label = "ΕΙΚΑΣΤΙΚΑ#ΕΡΓΑΣΤΗΡΙΑΚΟ";
        public Dictionary<int, string> Q1101Options = InMemory.getEduTypes();
        public string Q1102 { get; set; } = "";
        public string Q1102Label = "ΚΟΥΚΛΟΘΕΑΤΡΟ-ΘΕΑΤΡΟ ΣΚΙΩΝ#ΕΡΓΑΣΤΗΡΙΑΚΟ";
        public Dictionary<int, string> Q1102Options = InMemory.getEduTypes();
        public string Q1103 { get; set; } = "";
        public string Q1103Label = "ΜΟΥΣΙΚΟΚΙΝΗΤΙΚΗ ΑΓΩΓΗ#ΜΙΚΤΟ";
        public Dictionary<int, string> Q1103Options = InMemory.getEduTypes();
        public string Q1104 { get; set; } = "";
        public string Q1104Label = "ΠΑΙΧΝΙΔΙ-ΘΕΑΤΡΙΚΟ ΠΑΙΧΝΙΔΙ#ΕΡΓΑΣΤΗΡΙΑΚΟ";
        public Dictionary<int, string> Q1104Options = InMemory.getEduTypes();
        public string Q1105 { get; set; } = "";
        public string Q1105Label = "ΠΡΑΚΤΙΚΗ ΑΣΚΗΣΗ#ΕΡΓΑΣΤΗΡΙΑΚΟ";
        public Dictionary<int, string> Q1105Options = InMemory.getEduTypes();

        public string Q1106 { get; set; } = "";
        public string Q1106Label = "ΣΤΟΙΧΕΙΑ ΔΙΑΙΤΗΤΙΚΗΣ#ΘΕΩΡΗΤΙΚΟ";
        public Dictionary<int, string> Q1106Options = InMemory.getEduTypes();
        public string Q1107 { get; set; } = "";
        public string Q1107Label = "ΣΤΟΙΧΕΙΑ ΕΙΔΙΚΗΣ ΑΓΩΓΗΣ#ΘΕΩΡΗΤΙΚΟ";
        public Dictionary<int, string> Q1107Options = InMemory.getEduTypes();
        public string Q1108 { get; set; } = "";
        public string Q1108Label = "ΣΤΟΙΧΕΙΑ ΟΡΓΑΝΩΣΗΣ ΒΡΕΦΟΝΗΠΙΑΚΟΥ ΣΤΑΘΜΟΥ#ΘΕΩΡΗΤΙΚΟ";
        public Dictionary<int, string> Q1108Options = InMemory.getEduTypes();

        public string Q1109 { get; set; } = "";
        public string Q1109Label = "ΣΤΟΙΧΕΙΑ ΕΙΔΙΚΗΣ ΑΓΩΓΗΣ#ΘΕΩΡΗΤΙΚΟ";
        public Dictionary<int, string> Q1109Options = InMemory.getEduTypes();

        public string Q1200 = "ΒΟΗΘΟΣ ΝΟΣΗΛΕΥΤΙΚΗΣ ΓΕΝΙΚΗΣ ΝΟΣΗΛΕΙΑΣ (Γ Εξάμηνο)";
        public string Q1201 { get; set; } = "";
        public string Q201Label = "ΑΙΜΟΔΟΣΙΑ#ΘΕΩΡΗΤΙΚΟ";
        public Dictionary<int, string> Q201Options = InMemory.getEduTypes();
        public string Q1202 { get; set; } = "";
        public string Q202Label = "ΑΠΟΣΤΕΙΡΩΣΗ-ΑΠΟΛΥΜΑΝΣΗ#ΜΙΚΤΟ";
        public Dictionary<int, string> Q202Options = InMemory.getEduTypes();
        public string Q1203 { get; set; } = "";
        public string Q203Label = "ΝΟΣΗΛΕΥΤΙΚΗ (ΠΡΑΚΤΙΚΗ ΣΤΟ ΝΟΣΟΚΟΜΕΙΟ)ΙΙ#ΕΡΓΑΣΤΗΡΙΑΚΟ";
        public Dictionary<int, string> Q203Options = InMemory.getEduTypes();
        public string Q1204 { get; set; } = "";
        public string Q204Label = "ΧΕΙΡΟΥΡΓΙΚΗ ΙΙ#ΘΕΩΡΗΤΙΚΟ";
        public Dictionary<int, string> Q204Options = InMemory.getEduTypes();


        public string Q1300 = "ΒΟΗΘΟΣ ΦΑΡΜΑΚΕΙΟΥ (Α Εξάμηνο)";
        public string Q1301 { get; set; } = "";
        public string Q1301Label = "ΚΟΣΜΕΤΟΛΟΓΙΑ Ι#ΜΙΚΤΟ";
        public Dictionary<int, string> Q1301Options = InMemory.getEduTypes();
        public string Q1302 { get; set; } = "";
        public string Q1302Label = "ΜΕΘΟΔΟΙ ΕΛΕΓΧΟΥ ΦΑΡΜΑΚΟΥ#ΜΙΚΤΟ";
        public Dictionary<int, string> Q1302Options = InMemory.getEduTypes();
        public string Q1303 { get; set; } = "";
        public string Q1303Label = "ΠΡΑΚΤΙΚΗ ΕΦΑΡΜΟΓΗ ΣΤΗΝ ΕΙΔΙΚΟΤΗΤΑ#ΕΡΓΑΣΤΗΡΙΑΚΟ";
        public Dictionary<int, string> Q1303Options = InMemory.getEduTypes();
        public string Q1304 { get; set; } = "";
        public string Q1304Label = "ΦΑΡΜΑΚΕΥΤΙΚΗ ΤΕΧΝΟΛΟΓΙΑ Ι#ΜΙΚΤΟ";
        public Dictionary<int, string> Q1304Options = InMemory.getEduTypes();
        public string Q1305 { get; set; } = "";
        public string Q1305Label = "ΦΑΡΜΑΚΕΥΤΙΚΗ ΦΥΣΙΚΗ#ΜΙΚΤΟ";
        public Dictionary<int, string> Q1305Options = InMemory.getEduTypes();

        public string Q1306 { get; set; } = "";
        public string Q1306Label = "ΦΑΡΜΑΚΟΛΟΓΙΑ-ΤΟΞΙΚΟΛΟΓΙΑ#ΘΕΩΡΗΤΙΚΟ";
        public Dictionary<int, string> Q1306Options = InMemory.getEduTypes();
        

        public string Q104 { get; set; } = "";
        public string Q104Label = "ΠΑΙΧΝΙΔΙ-ΘΕΑΤΡΙΚΟ ΠΑΙΧΝΙΔΙ#ΕΡΓΑΣΤΗΡΙΑΚΟ";
        public Dictionary<int, string> Q104Options = InMemory.getEduTypes();
